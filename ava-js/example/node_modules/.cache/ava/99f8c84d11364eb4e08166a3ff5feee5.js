...
(0, _ava.default)('Test Example 1', t => {
  t.pass();
});
...
(0, _ava.default)("Promise test", t => {
  return promiseFn().then(value => {
    var _rec = new _powerAssertRecorder();

    return t.true(_rec._expr(_rec._capt(value, "arguments/0"), {
      content: "t.true(value)",
      filepath: "simple-tests/simple-examples.js",
      line: 15,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"value\",\"range\":[7,12]}],\"range\":[0,13]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"value\",\"range\":[7,12]},{\"type\":{\"label\":\")\"},\"range\":[12,13]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
});
(0, _ava.default)("Async/Await test", async t => {
  var _rec2 = new _powerAssertRecorder();

  const value = await promiseFn();
  t.true(_rec2._expr(_rec2._capt(value, "arguments/0"), {
    content: "t.true(value)",
    filepath: "simple-tests/simple-examples.js",
    line: 20,
    async: true,
...
_ava.default.cb("Callback Test", t => {
  cb(() => {
    t.pass();
    t.end();
  });
...
(0, _ava.default)('Observable Test', t => {
  return (0, _rxjs.of)("test").pipe((0, _operators.map)(result => t.is(result, "test")));
});
//# sourceMappingURL=/Users/reissjarvis/Documents/repos/talks/ava-js/example/node_modules/.cache/ava/99f8c84d11364eb4e08166a3ff5feee5.js.map