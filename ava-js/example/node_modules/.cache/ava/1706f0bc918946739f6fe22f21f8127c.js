...
_ava.default.cb('invokes callback synchronously', t => {
  t.plan(1);
  cb(() => {
    t.pass();
    t.end();
...
(0, _ava.default)('loops twice', t => {
  t.plan(2);

  for (let i = 0; i < 3; i++) {
    var _rec = new _powerAssertRecorder();

    t.true(_rec._expr(_rec._capt(_rec._capt(i, "arguments/0/left") < 3, "arguments/0"), {
      content: "t.true(i < 3)",
      filepath: "simple-tests/test-plan.js",
      line: 20,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"<\",\"left\":{\"type\":\"Identifier\",\"name\":\"i\",\"range\":[7,8]},\"right\":{\"type\":\"NumericLiteral\",\"value\":3,\"range\":[11,12]},\"range\":[7,12]}],\"range\":[0,13]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"i\",\"range\":[7,8]},{\"type\":{\"label\":\"</>\"},\"value\":\"<\",\"range\":[9,10]},{\"type\":{\"label\":\"num\"},\"value\":3,\"range\":[11,12]},{\"type\":{\"label\":\")\"},\"range\":[12,13]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  }
});
//# sourceMappingURL=/Users/reissjarvis/Documents/repos/talks/ava-js/example/node_modules/.cache/ava/1706f0bc918946739f6fe22f21f8127c.js.map